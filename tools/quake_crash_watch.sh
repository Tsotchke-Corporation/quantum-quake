...
scene_surface_budget="${QGE_SCENE_SURFACE_BUDGET:-160}"
...
echo "  quantum_render=$render_value quantum_render_res=$render_res quantum_rng=$rng_value quantum_ai=$ai_value"
