...
emit_builtin_plan() {
  case "$plan" in
    ...
    combat|combat-scout|combat-explore|adaptive)
      ...
      emit_action "wait 4"
      emit_action "turn-left 5"
      emit_action "attack 1"
      emit_action "turn-right 10"
      emit_action "attack 1"
      emit_action "turn-left 5"
      ...
      emit_action "strafe-left 6"
      emit_action "strafe-right 6"
      emit_action "clear-input 2"
      emit_action "back 5"
      emit_action "wall-slide-left 6"
      emit_action "turn-right 8"
      emit_action "jump-forward 5"
      emit_action "turn-left 6"
      emit_action "attack 1"
      emit_action "run-forward 12"
      emit_action "circle-left 6"
      emit_action "turn-left 6"
      emit_action "run-forward 10"
      emit_action "clear-input 2"
      ;;
    e1m1-route-push|route-push)
      ...
      emit_action "circle-left 6"
      emit_action "turn-left 10"
      emit_action "run-forward 14"
      emit_action "wall-slide-left 10"
      emit_action "run-forward 10"
      emit_action "scan-fire-left 12"
      emit_action "attack 2"
      emit_action "clear-input 2"
      emit_action "wall-slide-right 10"
      emit_action "door-open 8"
      emit_action "door-bump 6"
