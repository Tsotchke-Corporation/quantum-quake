...
qpic_t *Draw_PicFromWad (const char *name)
{
	...
	QGE_RegisterHudImageAsset(name,
							  p->width,
							  p->height,
							  gl.gltexture ? gl.gltexture->source_crc : 0,
							  gl.gltexture ? (unsigned int)gl.gltexture->source_format : 0,
							  QGE_HUD_IMAGE_FLAG_WAD,
							  p);
...
//
	...
	QGE_RegisterHudImageAsset(path,
							  pic->pic.width,
							  pic->pic.height,
							  gl.gltexture ? gl.gltexture->source_crc : 0,
							  gl.gltexture ? (unsigned int)gl.gltexture->source_format : 0,
							  QGE_HUD_IMAGE_FLAG_CACHE,
							  &pic->pic);
...
void Draw_LoadPics (void)
{
	...
	QGE_RegisterHudImageAsset(WADFILENAME":conchars",
							  128,
							  128,
							  char_texture ? char_texture->source_crc : 0,
							  char_texture ? (unsigned int)char_texture->source_format : 0,
							  QGE_HUD_IMAGE_FLAG_WAD,
							  data);
