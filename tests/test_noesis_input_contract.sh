...
grep -q 'manifest_source_input_audit_passed' "$repo_root/tools/qge_publication_pack.py"
grep -q 'manifest_source_input_mismatch_count' "$repo_root/tools/qge_publication_pack.py"
