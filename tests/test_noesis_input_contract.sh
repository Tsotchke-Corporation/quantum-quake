...
grep -q 'tri_budget = QGE_IsSnapshotViewmodel(edict)' "$repo_root/quake/Quake/qge_hooks.c"
...
grep -q 'Latest verified runtime baseline is the current QGE world fullbright sampling' "$repo_root/docs/qge_state_of_development.md"
...
grep -q 'scale plus diagnostic notify cleanup' "$repo_root/README.md"
