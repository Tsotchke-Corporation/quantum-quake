...
grep -q 'frames=12' "$repo_root/tools/quake_graphics_stream.sh"
grep -q 'waits_per_frame=20' "$repo_root/tools/quake_graphics_stream.sh"
grep -q 'capture_wait_override=""' "$repo_root/tools/quake_graphics_stream.sh"
grep -q 'frames=1' "$repo_root/tools/quake_graphics_harness.sh"
grep -q 'waits_per_frame=90' "$repo_root/tools/quake_graphics_harness.sh"
