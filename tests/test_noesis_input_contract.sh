...
grep -q 'QGE_NO_FLOOR_TONE_WHITE_HEADROOM 4.50f' "$repo_root/quake/Quake/qge_hooks.c"
...
grep -q 'QGE_TEXTURE_PREFILTER_MAX_FOOTPRINT 4.0f' "$repo_root/quake/Quake/qge_hooks.c"
...
grep -q 'bounded nine-tap palette prefilter' "$repo_root/docs/qge_agent_stream.md"
grep -q 'magnified and one-texel footprint' "$repo_root/docs/qge_agent_stream.md"
grep -q 'Mild minification stays on the bilinear path' "$repo_root/docs/qge_agent_stream.md"
