...
grep -q 'qge.map_set_selection.v0' "$repo_root/tools/qge_map_set_evidence.py"
grep -q 'QGE_MAP_SET_SELECTION' "$repo_root/tools/qge_map_set_evidence.py"
grep -q 'target_map_status' "$repo_root/tools/qge_map_set_evidence.py"
grep -q -- '--allow-partial' "$repo_root/tools/qge_map_set_evidence.py"
grep -q 'qge.map_set_evidence_audit.v0' "$repo_root/tools/qge_map_set_evidence_audit.py"
grep -q 'QGE_MAP_SET_EVIDENCE_AUDIT' "$repo_root/tools/qge_map_set_evidence_audit.py"
grep -q 'selection_breadth_mismatches' "$repo_root/tools/qge_map_set_evidence_audit.py"
grep -q 'qge.registered_full_game_progress.v0' "$repo_root/tools/qge_registered_full_game_progress.py"
grep -q 'QGE_REGISTERED_FULL_GAME_PROGRESS' "$repo_root/tools/qge_registered_full_game_progress.py"
grep -q 'target_map_progress' "$repo_root/tools/qge_registered_full_game_progress.py"
grep -q 'blocked_asset_missing' "$repo_root/tools/qge_registered_full_game_progress.py"
grep -q 'runtime_backend_scope_progress_status' "$repo_root/tools/qge_registered_full_game_progress.py"
grep -q 'runtime_backend_scope_next_blocker' "$repo_root/tools/qge_registered_full_game_progress.py"
grep -q 'qge.registered_full_game_progress_audit.v0' "$repo_root/tools/qge_registered_full_game_progress_audit.py"
grep -q 'QGE_REGISTERED_FULL_GAME_PROGRESS_AUDIT' "$repo_root/tools/qge_registered_full_game_progress_audit.py"
grep -q 'qge.shareware_episode1_selection.v0' "$repo_root/tools/qge_shareware_episode_evidence.py"
grep -q 'QGE_SHAREWARE_EPISODE1_SELECTION' "$repo_root/tools/qge_shareware_episode_evidence.py"
grep -q 'qge.shareware_episode1_evidence_audit.v0' "$repo_root/tools/qge_shareware_episode_evidence_audit.py"
grep -q 'QGE_SHAREWARE_EPISODE1_EVIDENCE_AUDIT' "$repo_root/tools/qge_shareware_episode_evidence_audit.py"
grep -q 'selection_breadth_mismatches' "$repo_root/tools/qge_shareware_episode_evidence_audit.py"
grep -q 'qge_shareware_episode1_breadth_evidence' "$repo_root/Makefile"
grep -q 'qge_shareware_episode1_breadth_audit' "$repo_root/Makefile"
grep -q 'qge_registered_full_game_breadth_status' "$repo_root/Makefile"
grep -q 'qge_registered_full_game_breadth_status_audit' "$repo_root/Makefile"
grep -q 'qge_registered_full_game_progress' "$repo_root/Makefile"
grep -q 'qge_registered_full_game_progress_audit' "$repo_root/Makefile"
...
grep -q 'qge_map_sets' "$repo_root/tools/qge_asset_inventory.py"
grep -q 'shareware_episode_one_asset_ready' "$repo_root/tools/qge_asset_inventory.py"
...
grep -q 'qge_moonlab_circuit_file_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -q 'advantage_generated_file_audit' "$repo_root/tools/qge_advantage_generated_file_audit.py"
grep -q 'content_mismatches' "$repo_root/tools/qge_advantage_generated_file_audit.py"
grep -q 'qge_advantage_generated_file_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -q 'agent_stream_icc_audit' "$repo_root/tools/qge_agent_stream_icc_audit.py"
grep -q 'entry_mismatches' "$repo_root/tools/qge_agent_stream_icc_audit.py"
grep -q 'qge_agent_stream_icc_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'REGISTERED_FULL_GAME_PROGRESS_FILENAME' "$repo_root/tools/qge_registered_asset_intake.py"
...
grep -q -- '--allow-empty-candidates' "$repo_root/tools/qge_registered_asset_intake.py"
...
grep -q 'registered_asset_handoff' "$repo_root/tools/qge_moonlab_full_game_plan.py"
grep -q 'asset_handoff_status' "$repo_root/tools/qge_moonlab_full_game_plan.py"
grep -q 'copy_plan_unblocked' "$repo_root/tools/qge_moonlab_full_game_plan.py"
grep -q 'blocked_non_registered_map_set' "$repo_root/tools/qge_moonlab_full_game_plan.py"
...
grep -q 'qge_moonlab_overclaim_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'recursive_overclaim_flags' "$repo_root/tools/qge_moonlab_overclaim_audit.py"
grep -q 'qge_moonlab_submission_packet_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'submission_packet_ledger_audit' "$repo_root/tools/qge_moonlab_submission_packet_audit.py"
grep -q 'moonlab_submission_packet_ledger_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'qge_moonlab_hardware_template_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'hardware_record_template_audit' "$repo_root/tools/qge_moonlab_hardware_template_audit.py"
grep -q 'moonlab_hardware_record_template_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'qge_moonlab_hardware_scope_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'hardware_submission_scope_audit' "$repo_root/tools/qge_moonlab_hardware_scope_audit.py"
grep -q 'moonlab_hardware_submission_scope_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'qge_moonlab_hardware_result_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'hardware_result_ledger_audit' "$repo_root/tools/qge_moonlab_hardware_result_audit.py"
grep -q 'moonlab_hardware_result_ledger_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'qge_moonlab_source_icc_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'source_icc_evidence_audit' "$repo_root/tools/qge_moonlab_source_icc_audit.py"
grep -q 'moonlab_source_icc_evidence_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'qge_resource_icc_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'resource_icc_evidence_audit' "$repo_root/tools/qge_resource_icc_audit.py"
grep -q 'resource_icc_evidence_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'qge_moonlab_advantage_icc_audit' "$repo_root/tools/qge_moonlab_deployment_gate.py"
grep -q 'advantage_icc_evidence_audit' "$repo_root/tools/qge_moonlab_advantage_icc_audit.py"
grep -q 'moonlab_advantage_icc_evidence_consistent' "$repo_root/tools/qge_moonlab_deployment_gate.py"
...
grep -q 'qge_moonlab_deployment_gate_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -q 'QGE_MOONLAB_DEPLOYMENT_GATE_AUDIT' "$repo_root/tools/qge_moonlab_deployment_gate_audit.py"
grep -q 'qge_moonlab_job_plan_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'qge_oracle_export' "$repo_root/tools/qge_oracle_claims_audit.py"
grep -q 'oracle_claims_evidence_audit' "$repo_root/tools/qge_oracle_claims_audit.py"
grep -q 'qge_oracle_claims_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -q 'qge_oracle_export' "$repo_root/tools/qge_oracle_icc_audit.py"
grep -q 'oracle_icc_evidence_audit' "$repo_root/tools/qge_oracle_icc_audit.py"
grep -q 'qge_oracle_icc_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -q 'qge_vanilla_capture_matrix' "$repo_root/tools/qge_runtime_icc_audit.py"
grep -q 'runtime_icc_sidecar_audit' "$repo_root/tools/qge_runtime_icc_audit.py"
grep -q 'agent_stream_performance_icc_evidence' "$repo_root/tools/qge_runtime_icc_audit.py"
grep -q 'qge_runtime_icc_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -q 'qge_publication_pack' "$repo_root/tools/qge_publication_icc_audit.py"
grep -q 'publication_icc_evidence_audit' "$repo_root/tools/qge_publication_icc_audit.py"
...
grep -q 'full_game_capture_queue_summary' "$repo_root/tools/qge_manifest_summary_audit.py"
...
grep -q 'OPTIONAL_MISSING_SOURCE_INPUTS' "$repo_root/tools/qge_manifest_source_input_audit.py"
grep -q 'manifest_source_input_icc_summary' "$repo_root/tools/qge_manifest_source_input_audit.py"
grep -q 'manifest_source_input_audit_passed' "$repo_root/tools/qge_manifest_source_input_audit.py"
grep -q 'manifest_source_input_mismatch_count' "$repo_root/tools/qge_manifest_source_input_audit.py"
grep -q 'manifest_source_copy_icc_summary' "$repo_root/tools/qge_manifest_source_copy_audit.py"
grep -q 'manifest_source_copy_audit_passed' "$repo_root/tools/qge_manifest_source_copy_audit.py"
grep -q 'manifest_source_copy_mismatch_count' "$repo_root/tools/qge_manifest_source_copy_audit.py"
grep -q 'scene_oracle_ir_doc' "$repo_root/tools/qge_manifest_source_input_audit.py"
grep -q 'architecture_doc' "$repo_root/tools/qge_manifest_source_input_audit.py"
grep -q 'advantage_roadmap_doc' "$repo_root/tools/qge_manifest_source_input_audit.py"
...
grep -q 'malformed_source_copy_record_count' "$repo_root/tools/qge_manifest_source_copy_audit.py"
grep -q 'qge_manifest_source_copy_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'child_audit_order_passed' "$repo_root/tools/qge_postpack_audit.py"
...
grep -q 'missing_source_inputs' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'manifest_reproduce_icc_summary' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'manifest_reproduce_missing_source_inputs' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'manifest_reproduce_optional_postpack_command_count' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'asset_requirements_reproduction' "$repo_root/tools/qge_manifest_reproduce_audit.py"
...
grep -q 'PUBLICATION_PACK_REPLAY_OUTDIR' "$repo_root/tools/qge_publication_pack.py"
grep -q 'PACK_ORACLE_SCENE' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'asset_requirements_reproduction_inputs' "$repo_root/tools/qge_publication_pack.py"
grep -q 'command_required_arg' "$repo_root/tools/qge_publication_pack.py"
! grep -q '"<capture_dir>"' "$repo_root/tools/qge_publication_pack.py"
! grep -q '"<graphics_capture_dir>"' "$repo_root/tools/qge_publication_pack.py"
! grep -q '"<outdir>"' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'REGISTERED_FULL_GAME_PROGRESS_SCHEMA' "$repo_root/tools/qge_full_game_capture_queue.py"
grep -q 'coverage_from_registered_progress' "$repo_root/tools/qge_full_game_capture_queue.py"
grep -q 'reproduction_inputs' "$repo_root/tools/qge_full_game_capture_queue.py"
grep -q 'qge.full_game_capture_queue_audit.v0' "$repo_root/tools/qge_full_game_capture_queue_audit.py"
grep -q 'QGE_FULL_GAME_CAPTURE_QUEUE_AUDIT' "$repo_root/tools/qge_full_game_capture_queue_audit.py"
grep -q 'PACK_QUEUE_PATH' "$repo_root/tools/qge_full_game_capture_queue_audit.py"
grep -q 'script_executable_mismatch' "$repo_root/tools/qge_full_game_capture_queue_audit.py"
...
grep -q -- '--map-set' "$repo_root/tools/qge_full_game_capture_queue.py"
grep -q 'map_scope' "$repo_root/tools/qge_full_game_capture_queue.py"
...
grep -q 'runtime_backend_scope_map_set' "$repo_root/tools/qge_breadth_evidence.py"
grep -q 'runtime_backend_scope_coverage_status' "$repo_root/tools/qge_breadth_evidence.py"
grep -q 'runtime_backend_scope_missing_map_count' "$repo_root/tools/qge_breadth_evidence.py"
...
grep -q 'qge_registered_full_game_coverage_ledger' "$repo_root/.icc/completion-oracles.json"
...
grep -q 'qge_shareware_episode1_breadth_evidence' "$repo_root/docs/qge_agent_stream.md"
grep -q 'qge_registered_full_game_breadth_status' "$repo_root/docs/qge_agent_stream.md"
grep -q 'qge_registered_full_game_progress_report' "$repo_root/docs/qge_agent_stream.md"
...
grep -q 'qge_asset_inventory.py --asset-root assets/id1 --map-set quake_registered_single_player' "$repo_root/docs/qge_agent_stream.md"
grep -q 'qge_registered_asset_intake.py --map-set quake_registered_single_player --candidate' "$repo_root/docs/qge_agent_stream.md"
...
grep -q 'qge_shareware_episode1_breadth_evidence' "$repo_root/docs/qge_publishable_results_research.md"
grep -q 'qge_registered_full_game_progress_report' "$repo_root/docs/qge_publishable_results_research.md"
...
grep -q 'qge_asset_inventory.py --asset-root assets/id1 --map-set quake_registered_single_player' "$repo_root/docs/qge_publishable_results_research.md"
grep -q 'qge_asset_requirements.py --asset-root assets/id1 --map-set quake_registered_single_player' "$repo_root/docs/qge_publishable_results_research.md"
grep -q 'qge_registered_asset_intake.py' "$repo_root/tools/qge_publication_pack.py"
grep -q 'registered_asset_intake_reproduce_command' "$repo_root/tools/qge_publication_pack.py"
grep -q 'registered_asset_intake_reproduction' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'qge_registered_full_game_progress.py' "$repo_root/tools/qge_publication_pack.py"
grep -q 'registered_full_game_progress_reproduce_command' "$repo_root/tools/qge_publication_pack.py"
grep -q 'registered_full_game_progress_reproduction' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'qge_registered_full_game_progress_audit.py' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'qge_full_game_capture_queue_audit.py' "$repo_root/tools/qge_manifest_reproduce_audit.py"
grep -q 'full_game_capture_queue_reproduction' "$repo_root/tools/qge_manifest_reproduce_audit.py"
...
grep -q 'qge_registered_full_game_progress.json' "$repo_root/tools/qge_publication_pack.py"
grep -q 'registered_full_game_progress_file' "$repo_root/tools/qge_publication_pack.py"
grep -q 'registered_full_game_progress_next_blocker' "$repo_root/tools/qge_publication_pack.py"
grep -q 'qge_full_game_capture_queue.json' "$repo_root/tools/qge_publication_pack.py"
grep -q 'full_game_capture_queue_reproduce_command' "$repo_root/tools/qge_publication_pack.py"
grep -q 'full_game_capture_queue_file' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'qge_map_sets' "$repo_root/tools/qge_publication_pack.py"
...
grep -q 'shareware_episode_one_requirements_satisfied' "$repo_root/tools/qge_asset_requirements.py"
grep -q 'keep_existing_shareware_asset' "$repo_root/tools/qge_asset_requirements.py"
grep -q 'qge_map_sets' "$repo_root/tools/qge_asset_requirements.py"
...
grep -q 'QGE_MOONLAB_FULL_GAME_PLAN_AUDIT' "$repo_root/tools/qge_moonlab_full_game_plan_audit.py"
grep -q 'qge.moonlab_full_game_deployment_plan.v0' "$repo_root/tools/qge_moonlab_full_game_plan.py"
grep -q 'map_deployment_rows' "$repo_root/tools/qge_moonlab_full_game_plan.py"
...
grep -q 'required_map_set' "$repo_root/tools/qge_moonlab_deployment_gate.py"
...
grep -q 'selected map-set coverage' "$repo_root/docs/qge_state_of_development.md"
grep -q 'quake_shareware_episode1' "$repo_root/docs/qge_state_of_development.md"
...
grep -Fq 'trace_summary_audit' "$repo_root/tools/qge_trace_summary_audit.py"
grep -Fq 'qge_trace_summary.parse_trace' "$repo_root/tools/qge_trace_summary_audit.py"
grep -Fq 'qge_trace_summary_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -Fq 'vanilla_matrix_audit' "$repo_root/tools/qge_vanilla_matrix_audit.py"
grep -Fq 'qge_vanilla_capture_matrix.build_matrix' "$repo_root/tools/qge_vanilla_matrix_audit.py"
grep -Fq 'qge_vanilla_matrix_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
grep -Fq 'breadth_evidence_audit' "$repo_root/tools/qge_breadth_evidence_audit.py"
grep -Fq 'qge_breadth_evidence.build_manifest' "$repo_root/tools/qge_breadth_evidence_audit.py"
grep -Fq 'recorded_map_set' "$repo_root/tools/qge_breadth_evidence_audit.py"
grep -Fq 'qge_map_sets.DEFAULT_FULL_GAME_MAP_SET' "$repo_root/tools/qge_breadth_evidence_audit.py"
grep -Fq 'qge_breadth_evidence_audit.py <pack_dir>' "$repo_root/tools/qge_publication_pack.py"
