...
grep -q 'QGE_SpatialKeepMaxRGB' "$repo_root/quake/Quake/qge_hooks.c"
grep -q 'Same-depth world samples use max-channel ownership' "$repo_root/docs/qge_agent_stream.md"
