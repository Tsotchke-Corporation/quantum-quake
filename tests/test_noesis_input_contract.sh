...
grep -q 'manifest_source_copy_icc_summary' "$repo_root/tools/qge_publication_pack.py"
grep -q 'manifest_source_copy_audit_passed' "$repo_root/tools/qge_publication_pack.py"
grep -q 'manifest_source_copy_mismatch_count' "$repo_root/tools/qge_publication_pack.py"
