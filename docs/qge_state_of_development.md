...
- `tools/qge_publication_pack.py --breadth-evidence` now carries that multi-map
  ...
  boundary ledgers, Moonlab job plan artifacts, hardware handoff artifacts, and
  ...
  and Moonlab `.moonlab` circuit body files are hashed against their JSON
  records before control-plane payload evidence is accepted.
