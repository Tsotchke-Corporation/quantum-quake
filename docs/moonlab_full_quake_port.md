...
resource boundary ledgers and deployment-gate JSON/ICC artifacts are recomputed
from their source artifacts before the postpack audit accepts them. Packed
Markdown evidence reports are regenerated from their source JSON ledgers before
