...
Packed breadth evidence is regenerated from the recorded source matrix ledgers
before all-map coverage counters are accepted. The remaining 23 maps are still
asset unavailable.
