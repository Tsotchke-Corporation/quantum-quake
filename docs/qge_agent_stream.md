...
- `QGE_RENDER`, `QGE_RENDER_RES`, `QGE_RENDER_THRESHOLD`,
  ...
  renderer) so foreground weapon lighting can be tuned without changing
  ordinary alias entities. Classic weapon placement and material parity remain
  separate renderer gaps.
