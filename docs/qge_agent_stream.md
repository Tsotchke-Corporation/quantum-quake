...
signoff, and the top-level publication ICC sidecar records the
reproduce/postpack audit verdict. Packed Markdown
...
frame, log, input, trace-summary, performance, audio-byte, and Noesis files
