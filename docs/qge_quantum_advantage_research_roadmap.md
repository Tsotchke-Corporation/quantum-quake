...
- The publication pack at
  `diagnostics/publication_pack/20260523-143208/` bundles the benchmark,
  ...
  `resource/qge_moonlab_replay_plan.json`, and the seven-map breadth evidence
  sidecar with per-target native backend proof maps. The map coverage artifact
  is `partial`: 7/32 canonical registered single-player maps covered and 25
